...
class Game(Bindable):
    ...
    def pre_game(self):
        ...
        print('player0s hand',self.players[0].hand)
        print('player1s hand',self.players[1].hand)
        input('hand')
    ...
    def play_single_turn(self):
        ...
        input('do turn overed')
        
        self._end_turn()
        
        print('current status',
              '\nplayers name', self.players[0].name,
              '\nmana', self.players[0].mana,
              '\ndeck', self.players[0].deck,
              '\nhand', self.players[0].hand,
              '\nplayers name', self.players[1].name,
              '\nmana', self.players[1].mana,
              '\ndeck', self.players[1].deck,
    ...
    def game_over(self):
        ...
        #print('player0 hp', self.players[0].hero.health)
        #print('player1 hp', self.players[1].hero.health)
